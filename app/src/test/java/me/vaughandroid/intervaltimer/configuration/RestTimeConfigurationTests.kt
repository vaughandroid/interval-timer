...
class RestTimeConfigurationTests {
    ...
    fun `rest time can be incremented`() {
        // Given
        val model = ConfigurationModel(Configuration(restTime = 12.seconds))
    ...
    fun `rest time can be decremented`() {
        // Given
        val model = ConfigurationModel(Configuration(restTime = 30.seconds))
    ...
    fun `rest time can't be less than 1 second`() {
        // Given
        val model = ConfigurationModel(Configuration(restTime = 1.seconds))
